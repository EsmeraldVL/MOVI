...
<head>
  ...
  <link href="<?php echo e(asset('css/headerStyle.scss')); ?>" rel="stylesheet">
  ...
  <link rel="icon" href="<?php echo e(asset('imagenes/LogoMovi.png')); ?>">
</head>

<body style="background-color:#003a55;">
  <header style="background-color: #34373F ;">
    <div style="background: url('<?php echo e(asset('imagenes/fondo.jpg')); ?>'); padding-bottom: 0px; margin-bottom:0px; margin-top:0px; height: 17rem"
    ...
    <nav class="navbar navbar-expand-lg  navbar-dark bg-dark" style="padding-top: 0px; margin-top: 0px ;">
      <a class="navbar-brand" href="<?php echo e(url('/home')); ?>">MOVI</a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <?php if(auth()->guard()->guest()): ?>
              ...
              <?php if(Route::has('register')): ?>
                  <li class="nav-item">
                      <a class="nav-link" style="color: rgb(209, 212, 12)" href="<?php echo e(route('register')); ?>"><?php echo e(__('Registrate en Movi')); ?></a>
                  </li>
              <?php endif; ?>
          <?php else: ?>
              <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                      ...
                      <a class="dropdown-item" href="<?php echo e(url('administracion/Users/'.Auth::user()->email)); ?>">Mi Perfil</a>
        ...
        <div class="form-inline my-2 my-lg-0">
          <button class="btn btn-info my-2 my-sm-0" ><img src="<?php echo e(url('imagenes/carrito-de-compras.png')); ?>" />  Mi Carrito</button>
        </div>
      </div>
    </nav>
  </header>
...
</html><?php /**PATH /var/www/html/MOVI-Proyecto/resources/views/admin/template/header.blade.php ENDPATH**/ ?>