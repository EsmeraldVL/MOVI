...
@section('estilos')
<link href="{{ asset('css/perfil.scss') }}" rel="stylesheet">
                  ...
                  <!------IMAGEN ---------->
                    ...
                    <div class="col-md-4" style="background-color: rgba(80, 80, 80, 0.3);;">
                        <div class="profile-img">
                                <img src="{{ asset('movi/imagesUser/'.$user->profile_image) }}" id='foto' style="padding-top: 1rem;"/>
                        ...
                        <div class="tab-content profile-tab" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <p>
                                                    <input name="name" id="nombresID" type="text" class="sinbordefondo" value="{{$user->name}}" disabled>
                                                </p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <p>
                                                    <input name="surname" id="apellidosID" type="text" class="sinbordefondo" value="{{$user->surname}}" disabled>
                                                </p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <p>
                                                    <input    type="text" class="sinbordefondo" style="width: 80%;" value="{{$email}}" disabled>
                                                </p>
                                            </div>
                                        </div>
                                        <div class="row">
