...
<div class="container py-5">
    ...
    <div class="row mb-4">
        <div class="col-lg-8 mx-auto text-center">
            ...
            <h1 class="display-6">Total a Pagar {{$totalDQ}}</h1>
        </div>
    </div> <!-- End -->
    <div class="row">
                ...
                <div class="card-header">
                    ...
                    <div id="paypal" class="tab-pane fade pt-3">
                        <form>
                            ...
                            <h4 class="pb-2">   Total a Pagar:       {{$totalMovis}} movis</h4>
                            <h4 class="pb-2">   -20% de descuento* = {{$totalModisDesc}} movis</h4>
                            <p class="text-muted">*cada compra que realices con movis tiene un 20% de descuento </p>
                            <input name="tipo"  value="2" hidden/>
                            @if ($movisUser>=$totalModisDesc)
