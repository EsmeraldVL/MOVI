                ...
                <div class="row">
                    <div class="col-12 col-md-7 pt-5 mb-5 align-self-center">
                        <div class="promo pe-md-3 pe-lg-5">
                            <h1 class="headline mb-3">
                                Titulo:         <strong>{{$Book->bookName}}</strong> 
                            </h1><!--//headline-->
                            <h3>
                                Autor:          <strong>{{$Book->author}}</strong>
                            </h3>
                            <h4>
                                Categoria:      <strong>{{$categoria->type}}</strong>
                            </h4>
                            ...
                            <div class="cta-holder row gx-md-3 gy-3 gy-md-0">
                                <form method="post"  action="{{ asset('library/pagar') }}" class="col-auto">
                                    ...
                                    <div class="col-12 col-md-auto">
                                        <input name="Libro" value="{{$Book->id}}" hidden/>
                                        <input name="isLibro" value="true" hidden/>
                                        <input name="category" value="{{$categoria->id}}" hidden/>
                    ...
                    <div class="col-12 col-md-5 mb-5" style="padding-top: 10%">
                        <div class="book-cover-holder" >
                            <img class="img-fluid book-cover" src="{{ asset('movi/imagesBooks/'.$Book->image) }}" alt="book cover" >
                            <div class="book-badge d-inline-block shadow">
                                Precio:<br>Q.{{$Book->price}}
                            </div>
...
@section('scripts')
    ...
    <script src="{{ asset('js/Libreria/paginalibro.js') }}"></script>
